...
!function () {
    ...
    f.prototype = {
        ...
        defaultMessages: {
            ...
            maxLength: "Поле должно содержать не более :value characters",
            minLength: "Поле должно содержать минимум :value characters",
            password: "Пароль не действителен",
            ...
            "function": "Введите корректные данные"
        },
        ...
        validateElements: function () {
            ...
            return this.lockForm(), this.elements.forEach(function (t) {
                ...
                t.forEach(function (t) {
                    return "ok" === t ? void e.renderErrors() : ("error" === t.type && alert("Произошла ошибка сервера. Пожалуйста, попробуйте позже."), e.generateMessage(l, t.name), void e.renderErrors())
                })
